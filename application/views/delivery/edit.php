    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <?php
                ...
                echo form_open('delivery/edit', $attributes);
            ?>
            ...
            <div class="box-body">
                        ...
                        <?php /* <select class="form-control" name="vendorId">
                            <?php
                                foreach ($vendor as $vend){
                                    ...
                                    echo $vend->vendorId==$row->vendorId?'selected':'';
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <textarea class="form-control" name="description" rows="4" placeholder="Enter ..." required><?php echo $row->description;?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="driver" class="form-control" placeholder="* Driver" value="<?php echo $row->driver;?>" required/>
                    </div>
                </div>
